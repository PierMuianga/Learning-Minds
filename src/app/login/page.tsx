...
export default async function LoginPage() { const { user, profile } = await getViewer(); if (user) redirect(destinationFor(profile)); return <AuthFrame mode="login"><AuthForm mode="login" /></AuthFrame>; }
